# NYC Yellow Taxi Modeling Report (2016)
...
- Train tip share: 96.23%
- Validation tip share: 96.23%

## Best Models
- Regression winner: `optimized_lightgbm_regression` | RMSE=1.1806 | MAE=0.5702 | R2=0.7279
- Classification winner: `optimized_random_forest_classifier` | ROC-AUC=0.5969 | AP=0.9707 | F1=0.9808

## Baseline Gains
- Regression RMSE gain vs naive mean: 1.0826
...
- `is_airport_trip`: 0.5788
- `borough_Brooklyn`: 0.2323
- `tolls_amount`: 0.2147
- `extra`: 0.1791
- `fare_amount`: 0.1733

### Simple Logistic Regression (Top Positive Log-Odds Drivers)
- `borough_Manhattan`: 0.8604
- `borough_Unknown`: 0.7873
- `is_airport_trip`: 0.6250
- `hour_Evening Commute`: 0.5183
- `hour_Nightlife`: 0.4549
