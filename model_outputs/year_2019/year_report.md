# NYC Yellow Taxi Modeling Report (2019)
...
- Train tip share: 96.65%
- Validation tip share: 96.65%

## Best Models
- Regression winner: `optimized_lightgbm_regression` | RMSE=1.5440 | MAE=0.6677 | R2=0.6439
- Classification winner: `optimized_random_forest_classifier` | ROC-AUC=0.6846 | AP=0.9799 | F1=0.9837

## Baseline Gains
- Regression RMSE gain vs naive mean: 1.0433
- Classification AUC gain vs naive majority: 0.1846
...
- `is_airport_trip`: 0.6434
- `tolls_amount`: 0.1899
- `fare_amount`: 0.1824
- `congestion_surcharge`: 0.1411
- `month_December`: 0.0706

### Simple Logistic Regression (Top Positive Log-Odds Drivers)
- `borough_Unknown`: 3.2087
- `is_airport_trip`: 2.6323
- `borough_Manhattan`: 2.3101
- `borough_Queens`: 1.7155
- `borough_Brooklyn`: 1.7111
