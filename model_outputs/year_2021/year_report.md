# NYC Yellow Taxi Modeling Report (2021)
...
- Train tip share: 96.66%
- Validation tip share: 96.66%

## Best Models
- Regression winner: `optimized_lightgbm_regression` | RMSE=1.5559 | MAE=0.6899 | R2=0.6107
- Classification winner: `optimized_random_forest_classifier` | ROC-AUC=0.6407 | AP=0.9781 | F1=0.9831

## Baseline Gains
- Regression RMSE gain vs naive mean: 0.9377
- Classification AUC gain vs naive majority: 0.1407
...
- `borough_Brooklyn`: 0.8002
- `is_airport_trip`: 0.5052
- `borough_Unknown`: 0.4407
- `borough_Manhattan`: 0.2854
- `tolls_amount`: 0.1949

### Simple Logistic Regression (Top Positive Log-Odds Drivers)
- `borough_Unknown`: 1.1999
- `is_airport_trip`: 1.1213
- `congestion_surcharge`: 0.6534
- `hour_Evening Commute`: 0.5127
- `hour_Daytime`: 0.4965
